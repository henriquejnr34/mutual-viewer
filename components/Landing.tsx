...
const Landing: React.FC<LandingProps> = ({ onFind }) => {
  return (
    <div className="text-center flex flex-col items-center">
      ...
      <p className="text-lg text-gray-400 max-w-md mb-8">
        See the mutuals for <span className="font-bold text-white">@naoerapaulo</span> in a fun, interactive way. Hit the button below and get ready to spot your friends!
      </p>
      <button
        onClick={onFind}
